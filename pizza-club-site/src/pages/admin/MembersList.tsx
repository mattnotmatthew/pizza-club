    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900"><TranslatedText>Members</TranslatedText></h1>
          <Link to="/admin/members/new">
            <Button><TranslatedText>Add New Member</TranslatedText></Button>
          </Link>
        </div>

        {members.length === 0 ? (
          <div className="bg-white shadow rounded-lg p-6">
            <p className="text-gray-600"><TranslatedText>No members yet. Add your first one!</TranslatedText></p>
          </div>
        ) : (
          <>
            <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong><TranslatedText>Tip:</TranslatedText></strong> <TranslatedText>Drag the handles on the left of each card to reorder members. Changes are saved automatically.</TranslatedText>
              </p>
            </div>
            
            {reordering && (
              <div className="mb-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <p className="text-sm text-yellow-800"><TranslatedText>Saving new order...</TranslatedText></p>
              </div>
            )}
